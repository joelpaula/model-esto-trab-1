---
title: "Métodos Estocásticos - Trabalho 1"
subtitle: 'Ciência de Dados - PL | Professora: Catarina Marques'
author: 
...
elephant_in_boa_mixture <- function(mu_a, mu_b, 
    ...
    lines(t, p_a * dnorm(t, mu_a, desv_pad) + p_b * dnorm(t, mu_b, desv_pad), 
          lwd = 1, col = "red")
    text(0,.45, 
     str_glue('fdp mistura fx = {p_a} N({mu_a}, {desv_pad}) + {p_b} N({mu_b}, {desv_pad})'), 
     col="red")
    ...
    text(0,0.38, 
     str_glue("{n} NPA mistura {p_a} N({mu_a}, {desv_pad}) + {p_b} N({mu_b}, {desv_pad})"))
...
Verificamos que a curva anterior está muito ténue, por isso:
 1 - aproximamos a média da segunda normal à primeira;
